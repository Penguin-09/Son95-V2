	...
	return (
		...
		>
			<div ref={nodeRef} className="window w-fit">
				{/* Header */}
				<div className="window-header flex cursor-grab items-center justify-center gap-3 bg-[var(--window-header-background)] p-[3px] text-center text-white active:cursor-grabbing">
					{title}
