		...
		<div className="flex h-full flex-col">
			<div className="flex flex-col gap-3">
				...
				<p>
					...
					as a personal portfolio. With Son95, you can discover information
					about me and my work. Click on an app to get started!
				</p>
			</div>

			<button
				type="button"
				className="window-button mt-auto ml-auto w-fit px-1"
				onClick={onClose}
			>
				Got it!
			</button>
